...
const statusIndex: Record<TimesheetStatus, number> = {
  ...
  SUBMITTED: 1,
  APPROVED: 2,
  REJECTED: 1, // sits at "submitted" position but shows rejected color
};
...
export function StatusProgress({ status }: StatusProgressProps) {
  ...
  return (
    <div className="flex items-center gap-0">
      {STEPS.map((step, i) => {
        const isComplete = i < currentIndex || (i === currentIndex && !isRejected && status !== "DRAFT");
            ...
            <div className="flex flex-col items-center">
              <div
                className={cn(
                  ...
                  isCurrent && !isComplete && !isRejectedStep && "border-primary-500 bg-white text-primary-600",
              ...
              <span
                className={cn(
                  ...
                  isCurrent && !isComplete && !isRejectedStep && "text-primary-600",
